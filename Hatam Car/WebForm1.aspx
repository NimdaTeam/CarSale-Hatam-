...
<link href="Assets/css/css/font.css" rel="stylesheet" />
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="padding-top:25px">
	    <div class="container-fluid px-md-4	">
	       <a class="navbar-brand" href="index.html">Khodro.Shop</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto " dir="rtl">
	          <li class="nav-item active"><a href="index.html" class="nav-link" style="font-family:Titr">خانه</a></li>
	          <li class="nav-item"><a href="browsejobs.html" class="nav-link" style="font-family:Titr">آگهی ها</a></li>
	          <li class="nav-item"><a href="candidates.html" class="nav-link" style="font-family:Titr">خودرو</a></li>
	          <li class="nav-item"><a href="blog.html" class="nav-link" style="font-family:Titr">فلان</a></li>
	          <li class="nav-item"><a href="contact.html" class="nav-link" style="font-family:Titr">ارتباط با ما</a></li>
	          <li class="nav-item cta mr-md-1"><a href="new-post.html" class="nav-link" style="font-family:Titr">Post a Job</a></li>
